...
namespace Calamitytwinklefragment.Content.Items.Weapons.Mana.StardustLine
{
    internal class StarWish : ModItem
    {
        ...
        private static float starf = Starff();
        public override void SetDefaults()
        {
            ...
            Item.knockBack = 4f;
            Item.value = Item.sellPrice(3, 0, 0, 0); // 物品价值
        ...
        {
            CreateRecipe().
                AddIngredient<FinalPray>().//
                AddIngredient<AstralStaff> ().
                AddIngredient(ItemType<CosmiliteBar>(), 8).
                AddIngredient(ItemType<GalacticaSingularity> (),12).
                AddTile<CosmicAnvil>().
                Register();
        }
    }
